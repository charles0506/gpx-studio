...
export const basemaps: { [key: string]: string | StyleSpecification } = {
    libertyTopo: 'https://tiles.openfreemap.org/styles/liberty',
    ...
    rudyMap: {
        ...
        sources: {
            rudyMap: {
                ...
                maxzoom: 20,
                attribution:
                    '&copy; <a href="https://twmap.happyman.idv.tw/map/" target="_blank">魯地圖</a>, &copy; <a href="https://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap contributors</a>',
            },
        },
        layers: [
            {
